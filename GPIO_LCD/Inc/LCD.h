...
#define TRIS_LCD_E      TRISE
#define LAT_LCD_E       LATE
#define LCD_E           2
#define TRIS_LCD_W      TRISE
#define LAT_LCD_W       LATE
#define LCD_W           1
#define TRIS_LCD_RS     TRISE
#define LAT_LCD_RS      LATE
#define LCD_RS          0
...
#define LCD_E_HIGH()    LAT_LCD_E |= (1 << LCD_E)
#define LCD_E_LOW()     LAT_LCD_E &= ~(1 << LCD_E)
#define LCD_RS_HIGH()   LAT_LCD_RS |= (1 << LCD_RS)
#define LCD_RS_LOW()    LAT_LCD_RS &= ~(1 << LCD_RS)
