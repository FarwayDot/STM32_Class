...
//Obtain port of a defined element
#define GPIOX_PORT_(a, b)     GPIO ## a
#define GPIOX_PORT(a)         GPIOX_PORT_(a)
//Obtain number part of a defined element
...
#define GPIO_CLOCK_ENABLE(a){  RCC->AHB1ENR |= RCC_AHB1ENR_GPIO ## a ## EN;}
